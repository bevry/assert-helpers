...
``` html
<script type="module">
    import * as pkg from '//cdn.pika.dev/assert-helpers/^6.0.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/assert-helpers@^6.0.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/assert-helpers@6.0.0'
</script>
```
