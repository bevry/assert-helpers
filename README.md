...
``` typescript
import * as pkg from 'https://unpkg.com/assert-helpers@^11.7.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/assert-helpers@^11.7.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/assert-helpers@^11.7.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/assert-helpers@11.7.0'
</script>
```
