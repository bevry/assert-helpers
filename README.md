...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/assert-helpers@^10.2.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/assert-helpers@^10.2.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/assert-helpers@10.2.0'
</script>
```
